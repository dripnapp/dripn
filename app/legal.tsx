    ...
    <View style={[styles.container, { backgroundColor: themeConfig.background }]}>
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
        ...
        <View style={[styles.section, { backgroundColor: themeConfig.card }]}>
          <Text style={[styles.sectionTitle, { color: themeConfig.text }]}>Third-Party Payment Processing</Text>
        ...
        <View style={[styles.section, { backgroundColor: themeConfig.card }]}>
          <Text style={[styles.sectionTitle, { color: themeConfig.text }]}>Cryptocurrency Risk Disclosure</Text>
          <Text style={[styles.sectionContent, { color: themeConfig.textMuted }]}>
        ...
        <View style={[styles.section, { backgroundColor: themeConfig.card }]}>
          <Text style={[styles.sectionTitle, { color: themeConfig.text }]}>No Financial Advice</Text>
          <Text style={[styles.sectionContent, { color: themeConfig.textMuted }]}>
        ...
        <View style={[styles.section, { backgroundColor: themeConfig.card }]}>
          <Text style={[styles.sectionTitle, { color: themeConfig.text }]}>Redemption Process</Text>
          <Text style={[styles.sectionContent, { color: themeConfig.textMuted }]}>
        ...
        <View style={[styles.section, { backgroundColor: themeConfig.card }]}>
          <Text style={[styles.sectionTitle, { color: themeConfig.text }]}>Wallet Responsibility</Text>
          <Text style={[styles.sectionContent, { color: themeConfig.textMuted }]}>
        ...
        <View style={[styles.section, { backgroundColor: themeConfig.card }]}>
          <Text style={[styles.sectionTitle, { color: themeConfig.text }]}>Age Requirement</Text>
          <Text style={[styles.sectionContent, { color: themeConfig.textMuted }]}>
        ...
        <View style={[styles.section, { backgroundColor: themeConfig.card }]}>
          <Text style={[styles.sectionTitle, { color: themeConfig.text }]}>Regulatory Compliance</Text>
          <Text style={[styles.sectionContent, { color: themeConfig.textMuted }]}>
        ...
        <View style={[styles.section, { backgroundColor: themeConfig.card }]}>
          <Text style={[styles.sectionTitle, { color: themeConfig.text }]}>About CoinGate</Text>
          <Text style={[styles.sectionContent, { color: themeConfig.textMuted }]}>
