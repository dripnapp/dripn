  ...
  return (
    <View style={[styles.container, { backgroundColor: themeConfig.background }]}>
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
        <Text style={[styles.effectiveDate, { color: themeConfig.textMuted }]}>Effective Date: January 2026</Text>

        <View style={[styles.section, { backgroundColor: themeConfig.card }]}>
          <Text style={[styles.sectionTitle, { color: themeConfig.text }]}>1. Acceptance of Terms</Text>
          <Text style={[styles.sectionContent, { color: themeConfig.textMuted }]}>
        ...
        <View style={[styles.section, { backgroundColor: themeConfig.card }]}>
          <Text style={[styles.sectionTitle, { color: themeConfig.text }]}>2. Eligibility</Text>
          <Text style={[styles.sectionContent, { color: themeConfig.textMuted }]}>
        ...
        <View style={[styles.section, { backgroundColor: themeConfig.card }]}>
          <Text style={[styles.sectionTitle, { color: themeConfig.text }]}>3. Account Responsibilities</Text>
          <Text style={[styles.sectionContent, { color: themeConfig.textMuted }]}>
        ...
        <View style={[styles.section, { backgroundColor: themeConfig.card }]}>
          <Text style={[styles.sectionTitle, { color: themeConfig.text }]}>4. Earning Drips</Text>
          <Text style={[styles.sectionContent, { color: themeConfig.textMuted }]}>
        ...
        <View style={[styles.section, { backgroundColor: themeConfig.card }]}>
          <Text style={[styles.sectionTitle, { color: themeConfig.text }]}>5. Redemptions and Payouts</Text>
          <Text style={[styles.sectionContent, { color: themeConfig.textMuted }]}>
            Drips may be redeemed for XRP cryptocurrency once the minimum threshold is reached. All redemptions are processed by a licensed third-party payment processor. The Third-Party converts your drip value to XRP at real-time market rates and sends the XRP directly to your connected wallet. Drip'n does not hold, custody, or transfer any funds. Processing takes 1-3 business days. Once submitted, redemption requests cannot be cancelled, re-redeemed, or transferred to another user.
          </Text>
        </View>

        <View style={[styles.section, { backgroundColor: themeConfig.card }]}>
          <Text style={[styles.sectionTitle, { color: themeConfig.text }]}>6. Third-Party Services</Text>
          <Text style={[styles.sectionContent, { color: themeConfig.textMuted }]}>
            Drip'n uses a Third-Party for all cryptocurrency redemption processing. By using the redemption feature, you also agree to the Third-Party's terms of service. Drip'n is not responsible for any issues, delays, or disputes arising from these services.
          </Text>
        </View>

        <View style={[styles.section, { backgroundColor: themeConfig.card }]}>
          <Text style={[styles.sectionTitle, { color: themeConfig.text }]}>7. Prohibited Activities</Text>
          <Text style={[styles.sectionContent, { color: themeConfig.textMuted }]}>
        ...
        <View style={[styles.section, { backgroundColor: themeConfig.card }]}>
          <Text style={[styles.sectionTitle, { color: themeConfig.text }]}>8. Referral Program</Text>
          <Text style={[styles.sectionContent, { color: themeConfig.textMuted }]}>
        ...
        <View style={[styles.section, { backgroundColor: themeConfig.card }]}>
          <Text style={[styles.sectionTitle, { color: themeConfig.text }]}>9. Modifications</Text>
          <Text style={[styles.sectionContent, { color: themeConfig.textMuted }]}>
        ...
        <View style={[styles.section, { backgroundColor: themeConfig.card }]}>
          <Text style={[styles.sectionTitle, { color: themeConfig.text }]}>10. Limitation of Liability</Text>
          <Text style={[styles.sectionContent, { color: themeConfig.textMuted }]}>
            Drip'n is provided "as is" without warranties of any kind. We are not liable for any losses arising from cryptocurrency price fluctuations, network issues, third-party services, or incorrect wallet addresses provided by users.
          </Text>
        </View>

        <View style={[styles.section, { backgroundColor: themeConfig.card }]}>
          <Text style={[styles.sectionTitle, { color: themeConfig.text }]}>11. Contact</Text>
          <Text style={[styles.sectionContent, { color: themeConfig.textMuted }]}>
            For questions about these Terms, please contact us at dripnapp@proton.me or through the Contact Us page in the app.
          </Text>
        </View>

        <Text style={[styles.footer, { color: themeConfig.textMuted }]}>
